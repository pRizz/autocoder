# ART-0227: ui-src-lib-keyboard-ts

## Artifact Identity
- ART ID: ART-0227
- Path: ui/src/lib/keyboard.ts
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Provides shared frontend utility/API/type behavior in `ui/src/lib/keyboard.ts` for component and hook contracts. Primary symbols: isSubmitEnter.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0227` and `ui/src/lib/keyboard.ts` in `.planning/specs/INVENTORY.md`.
