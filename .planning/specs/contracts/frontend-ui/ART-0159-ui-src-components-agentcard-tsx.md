# ART-0159: ui-src-components-agentcard-tsx

## Artifact Identity
- ART ID: ART-0159
- Path: ui/src/components/AgentCard.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/AgentCard.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: AgentCard, AgentLogModal, getStateText, getStateColor, getAgentTypeBadge, getLogColor.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0159` and `ui/src/components/AgentCard.tsx` in `.planning/specs/INVENTORY.md`.
