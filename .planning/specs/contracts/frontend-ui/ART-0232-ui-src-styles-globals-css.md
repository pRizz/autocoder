# ART-0232: ui-src-styles-globals-css
...
## Purpose
Defines global style baseline behavior and theme primitives in `ui/src/styles/globals.css` for consistent UI rendering.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0232` and `ui/src/styles/globals.css` in `.planning/specs/INVENTORY.md`.
