# ART-0224: ui-src-hooks-usetheme-ts
...
## Purpose
Implements reusable state/data-fetching/realtime hook behavior in `ui/src/hooks/useTheme.ts` for frontend feature composition. Primary symbols: useTheme, getThemeClass, THEMES, ThemeId, ThemeOption.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0224` and `ui/src/hooks/useTheme.ts` in `.planning/specs/INVENTORY.md`.
