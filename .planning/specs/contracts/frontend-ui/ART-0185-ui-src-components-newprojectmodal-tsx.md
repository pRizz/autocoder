# ART-0185: ui-src-components-newprojectmodal-tsx

## Artifact Identity
- ART ID: ART-0185
- Path: ui/src/components/NewProjectModal.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/NewProjectModal.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: NewProjectModal, changeStep, handleNameSubmit, handleFolderSelect, handleFolderCancel, handleRetryInitializer, handleChatCancel, handleExitToProject.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0185` and `ui/src/components/NewProjectModal.tsx` in `.planning/specs/INVENTORY.md`.
