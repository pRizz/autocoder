# ART-0209: ui-src-components-ui-dropdown-menu-tsx
...
## Purpose
Implements reusable UI primitive behavior in `ui/src/components/ui/dropdown-menu.tsx` used across higher-level dashboard components. Primary symbols: DropdownMenu, DropdownMenuPortal, DropdownMenuTrigger, DropdownMenuContent, DropdownMenuGroup, DropdownMenuItem, DropdownMenuCheckboxItem, DropdownMenuRadioGroup.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0209` and `ui/src/components/ui/dropdown-menu.tsx` in `.planning/specs/INVENTORY.md`.
