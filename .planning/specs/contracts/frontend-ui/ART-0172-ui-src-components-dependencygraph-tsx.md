# ART-0172: ui-src-components-dependencygraph-tsx

## Artifact Identity
- ART ID: ART-0172
- Path: ui/src/components/DependencyGraph.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/DependencyGraph.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: DependencyGraph, FeatureNode, getLayoutedElements, DependencyGraphInner, StatusIcon, status.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0172` and `ui/src/components/DependencyGraph.tsx` in `.planning/specs/INVENTORY.md`.
