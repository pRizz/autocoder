# ART-0222: ui-src-hooks-useschedules-ts

## Artifact Identity
- ART ID: ART-0222
- Path: ui/src/hooks/useSchedules.ts
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements reusable state/data-fetching/realtime hook behavior in `ui/src/hooks/useSchedules.ts` for frontend feature composition. Primary symbols: useSchedules, useSchedule, useCreateSchedule, useUpdateSchedule, useDeleteSchedule, useToggleSchedule, useNextScheduledRun.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0222` and `ui/src/hooks/useSchedules.ts` in `.planning/specs/INVENTORY.md`.
