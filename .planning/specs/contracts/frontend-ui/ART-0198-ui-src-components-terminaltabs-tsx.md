# ART-0198: ui-src-components-terminaltabs-tsx

## Artifact Identity
- ART ID: ART-0198
- Path: ui/src/components/TerminalTabs.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/TerminalTabs.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: TerminalTabs, handleClickOutside.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0198` and `ui/src/components/TerminalTabs.tsx` in `.planning/specs/INVENTORY.md`.
