# ART-0186: ui-src-components-orchestratoravatar-tsx

## Artifact Identity
- ART ID: ART-0186
- Path: ui/src/components/OrchestratorAvatar.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/OrchestratorAvatar.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: OrchestratorAvatar, MaestroSVG, getStateAnimation, getStateGlow, getStateDescription.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0186` and `ui/src/components/OrchestratorAvatar.tsx` in `.planning/specs/INVENTORY.md`.
