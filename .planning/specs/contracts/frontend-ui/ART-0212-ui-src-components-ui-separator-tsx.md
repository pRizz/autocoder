# ART-0212: ui-src-components-ui-separator-tsx
...
## Purpose
Implements reusable UI primitive behavior in `ui/src/components/ui/separator.tsx` used across higher-level dashboard components. Primary symbols: Separator.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0212` and `ui/src/components/ui/separator.tsx` in `.planning/specs/INVENTORY.md`.
