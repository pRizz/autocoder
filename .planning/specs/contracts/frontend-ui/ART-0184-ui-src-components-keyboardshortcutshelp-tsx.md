# ART-0184: ui-src-components-keyboardshortcutshelp-tsx

## Artifact Identity
- ART ID: ART-0184
- Path: ui/src/components/KeyboardShortcutsHelp.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/KeyboardShortcutsHelp.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: KeyboardShortcutsHelp.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0184` and `ui/src/components/KeyboardShortcutsHelp.tsx` in `.planning/specs/INVENTORY.md`.
