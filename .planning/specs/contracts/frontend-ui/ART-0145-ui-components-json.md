...
## Purpose
Defines frontend build/lint/test/runtime configuration behavior in `ui/components.json` for deterministic local and CI execution.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0145` and `ui/components.json` in `.planning/specs/INVENTORY.md`.
