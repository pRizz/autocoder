# ART-0183: ui-src-components-kanbancolumn-tsx

## Artifact Identity
- ART ID: ART-0183
- Path: ui/src/components/KanbanColumn.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/KanbanColumn.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: KanbanColumn.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0183` and `ui/src/components/KanbanColumn.tsx` in `.planning/specs/INVENTORY.md`.
