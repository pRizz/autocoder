# ART-0189: ui-src-components-projectselector-tsx

## Artifact Identity
- ART ID: ART-0189
- Path: ui/src/components/ProjectSelector.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/ProjectSelector.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: ProjectSelector, handleProjectCreated, handleDeleteClick, handleCancelDelete.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0189` and `ui/src/components/ProjectSelector.tsx` in `.planning/specs/INVENTORY.md`.
