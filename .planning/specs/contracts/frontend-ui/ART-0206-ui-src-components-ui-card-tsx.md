# ART-0206: ui-src-components-ui-card-tsx
...
## Purpose
Implements reusable UI primitive behavior in `ui/src/components/ui/card.tsx` used across higher-level dashboard components. Primary symbols: Card, CardHeader, CardTitle, CardDescription, CardAction, CardContent, CardFooter.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0206` and `ui/src/components/ui/card.tsx` in `.planning/specs/INVENTORY.md`.
