...
## Purpose
Defines frontend behavior in `ui/index.html` as part of the UI runtime and operator experience stack.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0149` and `ui/index.html` in `.planning/specs/INVENTORY.md`.
