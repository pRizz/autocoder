# ART-0173: ui-src-components-devserverconfigdialog-tsx

## Artifact Identity
- ART ID: ART-0173
- Path: ui/src/components/DevServerConfigDialog.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/DevServerConfigDialog.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: DevServerConfigDialog.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0173` and `ui/src/components/DevServerConfigDialog.tsx` in `.planning/specs/INVENTORY.md`.
