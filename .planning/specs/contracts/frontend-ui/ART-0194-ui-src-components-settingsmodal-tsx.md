# ART-0194: ui-src-components-settingsmodal-tsx

## Artifact Identity
- ART ID: ART-0194
- Path: ui/src/components/SettingsModal.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/SettingsModal.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: SettingsModal, handleYoloToggle, handleModelChange, handleTestingRatioChange, handleBatchSizeChange, handleProviderChange, handleSaveAuthToken, handleSaveCustomBaseUrl.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0194` and `ui/src/components/SettingsModal.tsx` in `.planning/specs/INVENTORY.md`.
