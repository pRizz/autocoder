# ART-0199: ui-src-components-themeselector-tsx

## Artifact Identity
- ART ID: ART-0199
- Path: ui/src/components/ThemeSelector.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/ThemeSelector.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: ThemeSelector, handleClickOutside, handleMouseEnter, handleMouseLeave, handleThemeHover, handleThemeClick.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0199` and `ui/src/components/ThemeSelector.tsx` in `.planning/specs/INVENTORY.md`.
