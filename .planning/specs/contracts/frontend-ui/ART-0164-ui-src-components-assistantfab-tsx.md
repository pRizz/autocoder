# ART-0164: ui-src-components-assistantfab-tsx

## Artifact Identity
- ART ID: ART-0164
- Path: ui/src/components/AssistantFAB.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/AssistantFAB.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: AssistantFAB.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0164` and `ui/src/components/AssistantFAB.tsx` in `.planning/specs/INVENTORY.md`.
