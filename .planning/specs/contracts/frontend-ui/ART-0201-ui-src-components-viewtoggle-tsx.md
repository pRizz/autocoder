# ART-0201: ui-src-components-viewtoggle-tsx

## Artifact Identity
- ART ID: ART-0201
- Path: ui/src/components/ViewToggle.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/ViewToggle.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: ViewToggle, ViewMode.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0201` and `ui/src/components/ViewToggle.tsx` in `.planning/specs/INVENTORY.md`.
