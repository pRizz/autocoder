# ART-0153: ui-public-ollama-png

## Artifact Identity
- ART ID: ART-0153
- Path: ui/public/ollama.png
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Provides static frontend asset content in `ui/public/ollama.png` referenced by UI rendering flows.
...
## Direct Dependencies
- ART-0155 `ui/src/App.tsx`: Asset consumption in rendered UI.
- ART-0231 `ui/src/main.tsx`: Asset loading during app bootstrap.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0153` and `ui/public/ollama.png` in `.planning/specs/INVENTORY.md`.
