# ART-0217: ui-src-hooks-usecelebration-ts

## Artifact Identity
- ART ID: ART-0217
- Path: ui/src/hooks/useCelebration.ts
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements reusable state/data-fetching/realtime hook behavior in `ui/src/hooks/useCelebration.ts` for frontend feature composition. Primary symbols: useCelebration, playFanfare, fireConfetti, isAllComplete.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0217` and `ui/src/hooks/useCelebration.ts` in `.planning/specs/INVENTORY.md`.
