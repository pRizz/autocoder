# ART-0228: ui-src-lib-timeutils-ts

## Artifact Identity
- ART ID: ART-0228
- Path: ui/src/lib/timeUtils.ts
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Provides shared frontend utility/API/type behavior in `ui/src/lib/timeUtils.ts` for component and hook contracts. Primary symbols: utcToLocalWithDayShift, utcToLocal, localToUTCWithDayShift, localToUTC, shiftDaysForward, shiftDaysBackward, adjustDaysForDayShift, formatDuration.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0228` and `ui/src/lib/timeUtils.ts` in `.planning/specs/INVENTORY.md`.
