# ART-0168: ui-src-components-confirmdialog-tsx

## Artifact Identity
- ART ID: ART-0168
- Path: ui/src/components/ConfirmDialog.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/ConfirmDialog.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: ConfirmDialog.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0168` and `ui/src/components/ConfirmDialog.tsx` in `.planning/specs/INVENTORY.md`.
