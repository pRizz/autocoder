# ART-0162: ui-src-components-agentthought-tsx

## Artifact Identity
- ART ID: ART-0162
- Path: ui/src/components/AgentThought.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/AgentThought.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: AgentThought, isAgentThought, getLatestThought.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0162` and `ui/src/components/AgentThought.tsx` in `.planning/specs/INVENTORY.md`.
