# ART-0193: ui-src-components-schedulemodal-tsx

## Artifact Identity
- ART ID: ART-0193
- Path: ui/src/components/ScheduleModal.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/ScheduleModal.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: ScheduleModal, handleToggleDay.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0193` and `ui/src/components/ScheduleModal.tsx` in `.planning/specs/INVENTORY.md`.
