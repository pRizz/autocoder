# ART-0156: ui-src-components-activityfeed-tsx

## Artifact Identity
- ART ID: ART-0156
- Path: ui/src/components/ActivityFeed.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/ActivityFeed.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: ActivityFeed, formatTimestamp, getMascotColor.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0156` and `ui/src/components/ActivityFeed.tsx` in `.planning/specs/INVENTORY.md`.
