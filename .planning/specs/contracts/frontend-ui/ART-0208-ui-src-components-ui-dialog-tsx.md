# ART-0208: ui-src-components-ui-dialog-tsx
...
## Purpose
Implements reusable UI primitive behavior in `ui/src/components/ui/dialog.tsx` used across higher-level dashboard components. Primary symbols: Dialog, DialogTrigger, DialogPortal, DialogClose, DialogOverlay, DialogContent, DialogHeader, DialogFooter.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0208` and `ui/src/components/ui/dialog.tsx` in `.planning/specs/INVENTORY.md`.
