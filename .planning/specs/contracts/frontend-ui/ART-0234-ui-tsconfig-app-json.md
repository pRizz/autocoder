...
## Purpose
Defines frontend build/lint/test/runtime configuration behavior in `ui/tsconfig.app.json` for deterministic local and CI execution.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0234` and `ui/tsconfig.app.json` in `.planning/specs/INVENTORY.md`.
