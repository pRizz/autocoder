# ART-0167: ui-src-components-chatmessage-tsx
...
## Purpose
Implements feature-facing UI behavior in `ui/src/components/ChatMessage.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: ChatMessage.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0167` and `ui/src/components/ChatMessage.tsx` in `.planning/specs/INVENTORY.md`.
