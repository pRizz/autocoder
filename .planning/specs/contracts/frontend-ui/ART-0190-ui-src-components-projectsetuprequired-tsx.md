# ART-0190: ui-src-components-projectsetuprequired-tsx

## Artifact Identity
- ART ID: ART-0190
- Path: ui/src/components/ProjectSetupRequired.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/ProjectSetupRequired.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: ProjectSetupRequired.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0190` and `ui/src/components/ProjectSetupRequired.tsx` in `.planning/specs/INVENTORY.md`.
