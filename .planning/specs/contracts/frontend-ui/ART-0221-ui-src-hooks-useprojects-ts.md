# ART-0221: ui-src-hooks-useprojects-ts

## Artifact Identity
- ART ID: ART-0221
- Path: ui/src/hooks/useProjects.ts
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements reusable state/data-fetching/realtime hook behavior in `ui/src/hooks/useProjects.ts` for frontend feature composition. Primary symbols: useProjects, useProject, useCreateProject, useDeleteProject, useResetProject, useUpdateProjectSettings, useFeatures, useCreateFeature.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0221` and `ui/src/hooks/useProjects.ts` in `.planning/specs/INVENTORY.md`.
