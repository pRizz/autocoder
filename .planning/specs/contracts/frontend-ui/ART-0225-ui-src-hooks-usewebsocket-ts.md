# ART-0225: ui-src-hooks-usewebsocket-ts
...
## Purpose
Implements reusable state/data-fetching/realtime hook behavior in `ui/src/hooks/useWebSocket.ts` for frontend feature composition. Primary symbols: useProjectWebSocket.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0225` and `ui/src/hooks/useWebSocket.ts` in `.planning/specs/INVENTORY.md`.
