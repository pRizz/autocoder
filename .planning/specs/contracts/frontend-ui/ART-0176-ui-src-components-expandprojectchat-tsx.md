# ART-0176: ui-src-components-expandprojectchat-tsx

## Artifact Identity
- ART ID: ART-0176
- Path: ui/src/components/ExpandProjectChat.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/ExpandProjectChat.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: ExpandProjectChat, handleSendMessage, handleKeyDown, ConnectionIndicator.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0176` and `ui/src/components/ExpandProjectChat.tsx` in `.planning/specs/INVENTORY.md`.
