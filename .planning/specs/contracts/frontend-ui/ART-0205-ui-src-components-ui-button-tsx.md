# ART-0205: ui-src-components-ui-button-tsx
...
## Purpose
Implements reusable UI primitive behavior in `ui/src/components/ui/button.tsx` used across higher-level dashboard components. Primary symbols: Button.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0205` and `ui/src/components/ui/button.tsx` in `.planning/specs/INVENTORY.md`.
