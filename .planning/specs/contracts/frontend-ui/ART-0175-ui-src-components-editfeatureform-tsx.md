# ART-0175: ui-src-components-editfeatureform-tsx

## Artifact Identity
- ART ID: ART-0175
- Path: ui/src/components/EditFeatureForm.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/EditFeatureForm.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: EditFeatureForm, handleAddStep, handleRemoveStep, handleStepChange.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0175` and `ui/src/components/EditFeatureForm.tsx` in `.planning/specs/INVENTORY.md`.
