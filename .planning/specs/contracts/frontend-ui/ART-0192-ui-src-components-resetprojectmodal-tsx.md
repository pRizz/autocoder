# ART-0192: ui-src-components-resetprojectmodal-tsx

## Artifact Identity
- ART ID: ART-0192
- Path: ui/src/components/ResetProjectModal.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/ResetProjectModal.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: ResetProjectModal, handleClose.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0192` and `ui/src/components/ResetProjectModal.tsx` in `.planning/specs/INVENTORY.md`.
