# ART-0204: ui-src-components-ui-badge-tsx
...
## Purpose
Implements reusable UI primitive behavior in `ui/src/components/ui/badge.tsx` used across higher-level dashboard components. Primary symbols: Badge.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0204` and `ui/src/components/ui/badge.tsx` in `.planning/specs/INVENTORY.md`.
