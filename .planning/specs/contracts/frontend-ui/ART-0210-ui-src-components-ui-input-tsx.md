# ART-0210: ui-src-components-ui-input-tsx
...
## Purpose
Implements reusable UI primitive behavior in `ui/src/components/ui/input.tsx` used across higher-level dashboard components. Primary symbols: Input.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0210` and `ui/src/components/ui/input.tsx` in `.planning/specs/INVENTORY.md`.
