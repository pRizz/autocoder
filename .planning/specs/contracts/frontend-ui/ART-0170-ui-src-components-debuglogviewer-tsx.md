# ART-0170: ui-src-components-debuglogviewer-tsx

## Artifact Identity
- ART ID: ART-0170
- Path: ui/src/components/DebugLogViewer.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/DebugLogViewer.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: DebugLogViewer, setActiveTab, handleResizeStart, handleScroll, handleDevScroll, handleClear, getCurrentLogCount, isAutoScrollPaused.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0170` and `ui/src/components/DebugLogViewer.tsx` in `.planning/specs/INVENTORY.md`.
