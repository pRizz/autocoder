# ART-0165: ui-src-components-assistantpanel-tsx

## Artifact Identity
- ART ID: ART-0165
- Path: ui/src/components/AssistantPanel.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/AssistantPanel.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: AssistantPanel, getStoredConversationId, setStoredConversationId, handleMouseMove, handleMouseUp.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0165` and `ui/src/components/AssistantPanel.tsx` in `.planning/specs/INVENTORY.md`.
