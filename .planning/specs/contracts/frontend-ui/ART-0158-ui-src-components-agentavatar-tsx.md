# ART-0158: ui-src-components-agentavatar-tsx

## Artifact Identity
- ART ID: ART-0158
- Path: ui/src/components/AgentAvatar.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/AgentAvatar.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: AgentAvatar, getStateAnimation, getStateGlow, getStateDescription.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0158` and `ui/src/components/AgentAvatar.tsx` in `.planning/specs/INVENTORY.md`.
