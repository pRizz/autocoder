# ART-0163: ui-src-components-assistantchat-tsx

## Artifact Identity
- ART ID: ART-0163
- Path: ui/src/components/AssistantChat.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/AssistantChat.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: AssistantChat, handleSend, handleKeyDown.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0163` and `ui/src/components/AssistantChat.tsx` in `.planning/specs/INVENTORY.md`.
