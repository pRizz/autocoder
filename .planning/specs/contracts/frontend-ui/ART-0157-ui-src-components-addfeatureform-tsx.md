# ART-0157: ui-src-components-addfeatureform-tsx

## Artifact Identity
- ART ID: ART-0157
- Path: ui/src/components/AddFeatureForm.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/AddFeatureForm.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: AddFeatureForm, handleAddStep, handleRemoveStep, handleStepChange.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0157` and `ui/src/components/AddFeatureForm.tsx` in `.planning/specs/INVENTORY.md`.
