# ART-0213: ui-src-components-ui-switch-tsx
...
## Purpose
Implements reusable UI primitive behavior in `ui/src/components/ui/switch.tsx` used across higher-level dashboard components. Primary symbols: Switch.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0213` and `ui/src/components/ui/switch.tsx` in `.planning/specs/INVENTORY.md`.
