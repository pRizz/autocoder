# ART-0181: ui-src-components-humaninputform-tsx

## Artifact Identity
- ART ID: ART-0181
- Path: ui/src/components/HumanInputForm.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/HumanInputForm.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: HumanInputForm.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0181` and `ui/src/components/HumanInputForm.tsx` in `.planning/specs/INVENTORY.md`.
