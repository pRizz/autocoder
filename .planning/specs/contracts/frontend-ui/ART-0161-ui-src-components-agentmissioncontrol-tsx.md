# ART-0161: ui-src-components-agentmissioncontrol-tsx

## Artifact Identity
- ART ID: ART-0161
- Path: ui/src/components/AgentMissionControl.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/AgentMissionControl.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: AgentMissionControl, toggleActivityCollapsed.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0161` and `ui/src/components/AgentMissionControl.tsx` in `.planning/specs/INVENTORY.md`.
