...
## Purpose
Provides shared frontend utility/API/type behavior in `ui/src/lib/utils.ts` for component and hook contracts. Primary symbols: cn.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0230` and `ui/src/lib/utils.ts` in `.planning/specs/INVENTORY.md`.
