# ART-0223: ui-src-hooks-usespecchat-ts

## Artifact Identity
- ART ID: ART-0223
- Path: ui/src/hooks/useSpecChat.ts
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements reusable state/data-fetching/realtime hook behavior in `ui/src/hooks/useSpecChat.ts` for frontend feature composition. Primary symbols: useSpecChat, generateId, checkAndSend.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0223` and `ui/src/hooks/useSpecChat.ts` in `.planning/specs/INVENTORY.md`.
