# ART-0197: ui-src-components-terminal-tsx

## Artifact Identity
- ART ID: ART-0197
- Path: ui/src/components/Terminal.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/Terminal.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: Terminal, handleResize, connectIfNeeded, handleActivation.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0197` and `ui/src/components/Terminal.tsx` in `.planning/specs/INVENTORY.md`.
