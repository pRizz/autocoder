# ART-0215: ui-src-components-ui-tooltip-tsx
...
## Purpose
Implements reusable UI primitive behavior in `ui/src/components/ui/tooltip.tsx` used across higher-level dashboard components. Primary symbols: TooltipProvider, Tooltip, TooltipTrigger, TooltipContent.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0215` and `ui/src/components/ui/tooltip.tsx` in `.planning/specs/INVENTORY.md`.
