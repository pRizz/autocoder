# ART-0180: ui-src-components-folderbrowser-tsx

## Artifact Identity
- ART ID: ART-0180
- Path: ui/src/components/FolderBrowser.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/FolderBrowser.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: FolderBrowser, handleNavigate, handleNavigateUp, handleDriveSelect, handleEntryClick, handleSelect, getBreadcrumbs.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0180` and `ui/src/components/FolderBrowser.tsx` in `.planning/specs/INVENTORY.md`.
