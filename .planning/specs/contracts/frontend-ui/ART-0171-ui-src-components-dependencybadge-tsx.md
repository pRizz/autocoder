# ART-0171: ui-src-components-dependencybadge-tsx

## Artifact Identity
- ART ID: ART-0171
- Path: ui/src/components/DependencyBadge.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/DependencyBadge.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: DependencyBadge, DependencyIndicator.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0171` and `ui/src/components/DependencyBadge.tsx` in `.planning/specs/INVENTORY.md`.
