# ART-0214: ui-src-components-ui-textarea-tsx

## Artifact Identity
- ART ID: ART-0214
- Path: ui/src/components/ui/textarea.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements reusable UI primitive behavior in `ui/src/components/ui/textarea.tsx` used across higher-level dashboard components. Primary symbols: Textarea.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0214` and `ui/src/components/ui/textarea.tsx` in `.planning/specs/INVENTORY.md`.
