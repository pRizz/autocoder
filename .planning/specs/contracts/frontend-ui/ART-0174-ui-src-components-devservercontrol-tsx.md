# ART-0174: ui-src-components-devservercontrol-tsx

## Artifact Identity
- ART ID: ART-0174
- Path: ui/src/components/DevServerControl.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/DevServerControl.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: DevServerControl, useStartDevServer, useStopDevServer, handleStart, handleStop, handleOpenConfig, handleCloseConfig.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0174` and `ui/src/components/DevServerControl.tsx` in `.planning/specs/INVENTORY.md`.
