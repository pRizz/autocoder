# ART-0178: ui-src-components-featurecard-tsx

## Artifact Identity
- ART ID: ART-0178
- Path: ui/src/components/FeatureCard.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/FeatureCard.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: FeatureCard, getCategoryColor.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0178` and `ui/src/components/FeatureCard.tsx` in `.planning/specs/INVENTORY.md`.
