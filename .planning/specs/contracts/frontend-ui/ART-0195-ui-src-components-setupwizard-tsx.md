# ART-0195: ui-src-components-setupwizard-tsx
...
## Purpose
Implements feature-facing UI behavior in `ui/src/components/SetupWizard.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: SetupWizard, SetupItem.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0195` and `ui/src/components/SetupWizard.tsx` in `.planning/specs/INVENTORY.md`.
