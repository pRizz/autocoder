# ART-0187: ui-src-components-orchestratorstatuscard-tsx

## Artifact Identity
- ART ID: ART-0187
- Path: ui/src/components/OrchestratorStatusCard.tsx
- Category: FRONTEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements feature-facing UI behavior in `ui/src/components/OrchestratorStatusCard.tsx` for operator workflows, orchestration control, or status visualization. Primary symbols: OrchestratorStatusCard, getStateText, getStateColor, formatRelativeTime.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0187` and `ui/src/components/OrchestratorStatusCard.tsx` in `.planning/specs/INVENTORY.md`.
