# ART-0058: planning-research-pitfalls-md
...
## Purpose
Defines planning and verification behavior for `.planning/research/PITFALLS.md` used to drive deterministic phase execution and traceability. Key sections: Pitfalls Research, Critical Pitfalls, Pitfall 1: Incomplete artifact scope (missing ops/docs/scripts), Pitfall 2: High-level summaries instead of executable contracts, Pitfall 3: Preserving accidental behavior as parity requirement, Pitfall 4: Parity matrix without dependency-aware execution ordering.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0058` and `.planning/research/PITFALLS.md` in `.planning/specs/INVENTORY.md`.
