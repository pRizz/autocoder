# ART-0018: claude-skills-playwright-cli-references-session-management-md

## Artifact Identity
- ART ID: ART-0018
- Path: .claude/skills/playwright-cli/references/session-management.md
- Category: OPS_AUTOMATION
- Contract Version: 1.0

## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/skills/playwright-cli/references/session-management.md` to standardize repository workflows. Key sections: Browser Session Management, Named Browser Sessions, Browser 1: Authentication flow, Browser 2: Public browsing (separate cookies, storage), Commands are isolated by browser session, Browser Session Isolation Properties.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0018` and `.claude/skills/playwright-cli/references/session-management.md` in `.planning/specs/INVENTORY.md`.
