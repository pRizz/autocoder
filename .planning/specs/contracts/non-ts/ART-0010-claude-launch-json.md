...
## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/launch.json` to standardize repository workflows.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0010` and `.claude/launch.json` in `.planning/specs/INVENTORY.md`.
