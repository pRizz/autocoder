# ART-0011: claude-skills-frontend-design-license-txt

## Artifact Identity
- ART ID: ART-0011
- Path: .claude/skills/frontend-design/LICENSE.txt
- Category: OPS_AUTOMATION
- Contract Version: 1.0

## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/skills/frontend-design/LICENSE.txt` to standardize repository workflows.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0011` and `.claude/skills/frontend-design/LICENSE.txt` in `.planning/specs/INVENTORY.md`.
