# ART-0015: claude-skills-playwright-cli-skill-md
...
## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/skills/playwright-cli/SKILL.md` to standardize repository workflows. Key sections: Browser Automation with playwright-cli, Quick start, open new browser, navigate to a page, interact with the page using refs from the snapshot, take a screenshot.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0015` and `.claude/skills/playwright-cli/SKILL.md` in `.planning/specs/INVENTORY.md`.
