# ART-0001: claude-agents-code-review-md
...
## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/agents/code-review.md` to standardize repository workflows. Key sections: Your Core Philosophy, Review Methodology, 1. Code Quality & Readability, 2. Maintainability & Modularity, 3. Documentation & Comments, 4. Performance.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0001` and `.claude/agents/code-review.md` in `.planning/specs/INVENTORY.md`.
