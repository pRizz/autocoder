# ART-0032: planning-requirements-md
...
## Purpose
Defines planning and verification behavior for `.planning/REQUIREMENTS.md` used to drive deterministic phase execution and traceability. Key sections: Requirements: AutoForge 1:1 Regeneration Spec Initiative, v1 Requirements, Inventory & Scope, Execution Guardrails, File-Level Contract Specs, Cross-Cutting Surface Contracts.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0032` and `.planning/REQUIREMENTS.md` in `.planning/specs/INVENTORY.md`.
