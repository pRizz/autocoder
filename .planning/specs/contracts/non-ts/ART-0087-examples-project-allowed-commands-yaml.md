# ART-0087: examples-project-allowed-commands-yaml

## Artifact Identity
- ART ID: ART-0087
- Path: examples/project_allowed_commands.yaml
- Category: CONFIG_OR_MISC
- Contract Version: 1.0

## Purpose
Defines configuration or packaging behavior in `examples/project_allowed_commands.yaml` that influences runtime/tooling semantics.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0087` and `examples/project_allowed_commands.yaml` in `.planning/specs/INVENTORY.md`.
