...
## Purpose
Documents product/runtime behavior and usage expectations in `LICENSE.md` for operator and contributor guidance.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0070` and `LICENSE.md` in `.planning/specs/INVENTORY.md`.
