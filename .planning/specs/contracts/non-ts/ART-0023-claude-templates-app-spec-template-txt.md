# ART-0023: claude-templates-app-spec-template-txt

## Artifact Identity
- ART ID: ART-0023
- Path: .claude/templates/app_spec.template.txt
- Category: OPS_AUTOMATION
- Contract Version: 1.0

## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/templates/app_spec.template.txt` to standardize repository workflows.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0023` and `.claude/templates/app_spec.template.txt` in `.planning/specs/INVENTORY.md`.
