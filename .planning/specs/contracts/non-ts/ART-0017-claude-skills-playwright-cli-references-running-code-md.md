# ART-0017: claude-skills-playwright-cli-references-running-code-md

## Artifact Identity
- ART ID: ART-0017
- Path: .claude/skills/playwright-cli/references/running-code.md
- Category: OPS_AUTOMATION
- Contract Version: 1.0

## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/skills/playwright-cli/references/running-code.md` to standardize repository workflows. Key sections: Running Custom Playwright Code, Syntax, Geolocation, Grant geolocation permission and set location, Set location to London, Clear geolocation override.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0017` and `.claude/skills/playwright-cli/references/running-code.md` in `.planning/specs/INVENTORY.md`.
