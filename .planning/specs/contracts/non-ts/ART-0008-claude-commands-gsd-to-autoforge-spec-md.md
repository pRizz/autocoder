# ART-0008: claude-commands-gsd-to-autoforge-spec-md

## Artifact Identity
- ART ID: ART-0008
- Path: .claude/commands/gsd-to-autoforge-spec.md
- Category: OPS_AUTOMATION
- Contract Version: 1.0

## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/commands/gsd-to-autoforge-spec.md` to standardize repository workflows. Key sections: GSD to AutoForge Spec.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0008` and `.claude/commands/gsd-to-autoforge-spec.md` in `.planning/specs/INVENTORY.md`.
