# ART-0037: planning-codebase-conventions-md
...
## Purpose
Defines planning and verification behavior for `.planning/codebase/CONVENTIONS.md` used to drive deterministic phase execution and traceability. Key sections: Coding Conventions, Naming Patterns, Code Style, Import Organization, Error Handling, Logging.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0037` and `.planning/codebase/CONVENTIONS.md` in `.planning/specs/INVENTORY.md`.
