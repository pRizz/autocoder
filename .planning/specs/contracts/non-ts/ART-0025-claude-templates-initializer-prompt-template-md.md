# ART-0025: claude-templates-initializer-prompt-template-md

## Artifact Identity
- ART ID: ART-0025
- Path: .claude/templates/initializer_prompt.template.md
- Category: OPS_AUTOMATION
- Contract Version: 1.0

## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/templates/initializer_prompt.template.md` to standardize repository workflows. Key sections: YOUR ROLE - INITIALIZER AGENT (Session 1 of Many), FIRST: Read the Project Specification, REQUIRED FEATURE COUNT, CRITICAL FIRST TASK: Create Features, FEATURE DEPENDENCIES (MANDATORY), Dependency Rules.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0025` and `.claude/templates/initializer_prompt.template.md` in `.planning/specs/INVENTORY.md`.
