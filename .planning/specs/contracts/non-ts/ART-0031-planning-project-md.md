...
## Purpose
Defines planning and verification behavior for `.planning/PROJECT.md` used to drive deterministic phase execution and traceability. Key sections: AutoForge 1:1 Regeneration Spec Initiative, What This Is, Core Value, Requirements, Validated, Active.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0031` and `.planning/PROJECT.md` in `.planning/specs/INVENTORY.md`.
