# ART-0003: claude-agents-deep-dive-md

## Artifact Identity
- ART ID: ART-0003
- Path: .claude/agents/deep-dive.md
- Category: OPS_AUTOMATION
- Contract Version: 1.0

## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/agents/deep-dive.md` to standardize repository workflows. Key sections: Core Mission, Investigation Framework, Phase 1: Scope Understanding, Phase 2: Systematic Exploration, Phase 3: External Research, Phase 4: Deep Analysis.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0003` and `.claude/agents/deep-dive.md` in `.planning/specs/INVENTORY.md`.
