# ART-0020: claude-skills-playwright-cli-references-test-generation-md

## Artifact Identity
- ART ID: ART-0020
- Path: .claude/skills/playwright-cli/references/test-generation.md
- Category: OPS_AUTOMATION
- Contract Version: 1.0

## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/skills/playwright-cli/references/test-generation.md` to standardize repository workflows. Key sections: Test Generation, How It Works, Example Workflow, Start a session, Take a snapshot to see elements, Output shows: e1 [textbox "Email"], e2 [textbox "Password"], e3 [button "Sign In"].
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0020` and `.claude/skills/playwright-cli/references/test-generation.md` in `.planning/specs/INVENTORY.md`.
