# ART-0066: planning-specs-inventory-rules-md

## Artifact Identity
- ART ID: ART-0066
- Path: .planning/specs/INVENTORY-RULES.md
- Category: PLANNING_DOC
- Contract Version: 1.0

## Purpose
Defines planning and verification behavior for `.planning/specs/INVENTORY-RULES.md` used to drive deterministic phase execution and traceability. Key sections: Canonical Inventory Rules, Discovery, Inclusion, Exclusion, Classification, ID.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0066` and `.planning/specs/INVENTORY-RULES.md` in `.planning/specs/INVENTORY.md`.
