# ART-0056: planning-research-architecture-md
...
## Purpose
Defines planning and verification behavior for `.planning/research/ARCHITECTURE.md` used to drive deterministic phase execution and traceability. Key sections: Architecture Research, Standard Architecture, System Overview, Component Responsibilities, Recommended Project Structure, Structure Rationale.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0056` and `.planning/research/ARCHITECTURE.md` in `.planning/specs/INVENTORY.md`.
