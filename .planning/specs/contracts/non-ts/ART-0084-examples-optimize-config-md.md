# ART-0084: examples-optimize-config-md

## Artifact Identity
- ART ID: ART-0084
- Path: examples/OPTIMIZE_CONFIG.md
- Category: DOCUMENTATION
- Contract Version: 1.0

## Purpose
Documents product/runtime behavior and usage expectations in `examples/OPTIMIZE_CONFIG.md` for operator and contributor guidance. Key sections: How to Optimize Your allowed_commands.yaml, The Problem, ... 20+ more flutter commands, How Wildcards Work, Example: GOD-APP Optimization, Before (65 commands).
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0084` and `examples/OPTIMIZE_CONFIG.md` in `.planning/specs/INVENTORY.md`.
