...
## Purpose
Defines planning and verification behavior for `.planning/ROADMAP.md` used to drive deterministic phase execution and traceability. Key sections: Roadmap: AutoForge 1:1 Regeneration Spec Initiative, Overview, Phases, Phase Details, Phase 1: Scope Policy, Inventory, and Guardrails, Phase 2: Coverage Validation & Classification.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0033` and `.planning/ROADMAP.md` in `.planning/specs/INVENTORY.md`.
