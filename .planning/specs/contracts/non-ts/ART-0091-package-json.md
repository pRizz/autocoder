...
## Purpose
Defines configuration or packaging behavior in `package.json` that influences runtime/tooling semantics.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0091` and `package.json` in `.planning/specs/INVENTORY.md`.
