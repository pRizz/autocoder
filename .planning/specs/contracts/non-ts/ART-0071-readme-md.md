...
## Purpose
Documents product/runtime behavior and usage expectations in `README.md` for operator and contributor guidance. Key sections: AutoForge, Video Tutorial, Prerequisites, Claude Code CLI (Required), Authentication, Quick Start.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0071` and `README.md` in `.planning/specs/INVENTORY.md`.
