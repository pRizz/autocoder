...
## Purpose
Documents product/runtime behavior and usage expectations in `VISION.md` for operator and contributor guidance. Key sections: VISION, Claude Agent SDK Exclusivity.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0072` and `VISION.md` in `.planning/specs/INVENTORY.md`.
