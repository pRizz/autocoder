# ART-0009: claude-commands-review-pr-md
...
## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/commands/review-pr.md` to standardize repository workflows. Key sections: TASKS, Complexity Tiers.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0009` and `.claude/commands/review-pr.md` in `.planning/specs/INVENTORY.md`.
