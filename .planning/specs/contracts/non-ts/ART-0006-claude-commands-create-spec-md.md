# ART-0006: claude-commands-create-spec-md
...
## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/commands/create-spec.md` to standardize repository workflows. Key sections: PROJECT DIRECTORY, GOAL, YOUR ROLE, CONVERSATION FLOW, Phase 1: Project Overview, Phase 2: Involvement Level.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0006` and `.claude/commands/create-spec.md` in `.planning/specs/INVENTORY.md`.
