# ART-0013: claude-skills-gsd-to-autoforge-spec-skill-md

## Artifact Identity
- ART ID: ART-0013
- Path: .claude/skills/gsd-to-autoforge-spec/SKILL.md
- Category: OPS_AUTOMATION
- Contract Version: 1.0

## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/skills/gsd-to-autoforge-spec/SKILL.md` to standardize repository workflows. Key sections: GSD to AutoForge Spec Converter, When to Use, Prerequisites, Process, Step 1: Verify GSD Mapping Exists, Step 2: Read Codebase Documentation.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0013` and `.claude/skills/gsd-to-autoforge-spec/SKILL.md` in `.planning/specs/INVENTORY.md`.
