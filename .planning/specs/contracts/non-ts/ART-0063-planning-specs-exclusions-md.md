# ART-0063: planning-specs-exclusions-md

## Artifact Identity
- ART ID: ART-0063
- Path: .planning/specs/EXCLUSIONS.md
- Category: PLANNING_DOC
- Contract Version: 1.0

## Purpose
Defines planning and verification behavior for `.planning/specs/EXCLUSIONS.md` used to drive deterministic phase execution and traceability. Key sections: Exclusion Taxonomy Contract, Objective, Class Matrix, Decision Rules for Ambiguous Files, generated/runtime Boundary Guidance, change-control.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0063` and `.planning/specs/EXCLUSIONS.md` in `.planning/specs/INVENTORY.md`.
