# ART-0024: claude-templates-coding-prompt-template-md

## Artifact Identity
- ART ID: ART-0024
- Path: .claude/templates/coding_prompt.template.md
- Category: OPS_AUTOMATION
- Contract Version: 1.0

## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/templates/coding_prompt.template.md` to standardize repository workflows. Key sections: YOUR ROLE - CODING AGENT, STEP 1: GET YOUR BEARINGS (MANDATORY), 1. See your working directory, 2. List files to understand project structure, 3. Read the project specification to understand what you're building, 4. Read progress notes from previous sessions (last 500 lines to avoid context overflow).
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0024` and `.claude/templates/coding_prompt.template.md` in `.planning/specs/INVENTORY.md`.
