...
## Purpose
Defines planning and verification behavior for `.planning/STATE.md` used to drive deterministic phase execution and traceability. Key sections: Project State, Project Reference, Current Position, Performance Metrics, Accumulated Context, Decisions.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0034` and `.planning/STATE.md` in `.planning/specs/INVENTORY.md`.
