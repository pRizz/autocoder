# ART-0062: planning-specs-coverage-baseline-md

## Artifact Identity
- ART ID: ART-0062
- Path: .planning/specs/COVERAGE-BASELINE.md
- Category: PLANNING_DOC
- Contract Version: 1.0

## Purpose
Defines planning and verification behavior for `.planning/specs/COVERAGE-BASELINE.md` used to drive deterministic phase execution and traceability. Key sections: Coverage Baseline (Phase 2), Total in-scope, By category, Excluded, Required evidence, Reproducibility.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0062` and `.planning/specs/COVERAGE-BASELINE.md` in `.planning/specs/INVENTORY.md`.
