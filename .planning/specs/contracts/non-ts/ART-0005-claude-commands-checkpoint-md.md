# ART-0005: claude-commands-checkpoint-md
...
## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/commands/checkpoint.md` to standardize repository workflows.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0005` and `.claude/commands/checkpoint.md` in `.planning/specs/INVENTORY.md`.
