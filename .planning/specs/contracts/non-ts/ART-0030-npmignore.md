...
## Purpose
Defines configuration or packaging behavior in `.npmignore` that influences runtime/tooling semantics.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0030` and `.npmignore` in `.planning/specs/INVENTORY.md`.
