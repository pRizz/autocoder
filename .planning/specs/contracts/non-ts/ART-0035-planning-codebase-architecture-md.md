# ART-0035: planning-codebase-architecture-md
...
## Purpose
Defines planning and verification behavior for `.planning/codebase/ARCHITECTURE.md` used to drive deterministic phase execution and traceability. Key sections: Architecture, Pattern Overview, Layers, Data Flow, Key Abstractions, Entry Points.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0035` and `.planning/codebase/ARCHITECTURE.md` in `.planning/specs/INVENTORY.md`.
