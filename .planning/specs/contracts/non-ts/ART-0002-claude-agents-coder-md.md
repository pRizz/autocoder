# ART-0002: claude-agents-coder-md
...
## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/agents/coder.md` to standardize repository workflows. Key sections: Your Core Identity, Mandatory Workflow, Phase 1: Research and Understanding, Phase 2: Implementation, Phase 3: Verification, Project-Specific Context.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0002` and `.claude/agents/coder.md` in `.planning/specs/INVENTORY.md`.
