...
## Purpose
Implements operational startup/control behavior in `start.bat` for local runtime launch and environment preparation.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0132` and `start.bat` in `.planning/specs/INVENTORY.md`.
