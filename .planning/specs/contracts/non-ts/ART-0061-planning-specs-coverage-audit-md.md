# ART-0061: planning-specs-coverage-audit-md

## Artifact Identity
- ART ID: ART-0061
- Path: .planning/specs/COVERAGE-AUDIT.md
- Category: PLANNING_DOC
- Contract Version: 1.0

## Purpose
Defines planning and verification behavior for `.planning/specs/COVERAGE-AUDIT.md` used to drive deterministic phase execution and traceability. Key sections: Coverage Audit Report, Inputs, Pre-Remediation Findings, missing_from_inventory, extra_in_inventory, Remediation.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0061` and `.planning/specs/COVERAGE-AUDIT.md` in `.planning/specs/INVENTORY.md`.
