...
## Purpose
Documents product/runtime behavior and usage expectations in `requirements.txt` for operator and contributor guidance.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0099` and `requirements.txt` in `.planning/specs/INVENTORY.md`.
