# ART-0064: planning-specs-guardrails-md

## Artifact Identity
- ART ID: ART-0064
- Path: .planning/specs/GUARDRAILS.md
- Category: PLANNING_DOC
- Contract Version: 1.0

## Purpose
Defines planning and verification behavior for `.planning/specs/GUARDRAILS.md` used to drive deterministic phase execution and traceability. Key sections: Execution Guardrails (Docs-Only), Objective, Allowed Paths, Prohibited Paths, Compliance Checklist, Canonical Checks.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0064` and `.planning/specs/GUARDRAILS.md` in `.planning/specs/INVENTORY.md`.
