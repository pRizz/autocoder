...
## Purpose
Defines configuration or packaging behavior in `.env.example` that influences runtime/tooling semantics.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0027` and `.env.example` in `.planning/specs/INVENTORY.md`.
