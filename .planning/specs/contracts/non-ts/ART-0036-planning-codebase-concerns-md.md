# ART-0036: planning-codebase-concerns-md
...
## Purpose
Defines planning and verification behavior for `.planning/codebase/CONCERNS.md` used to drive deterministic phase execution and traceability. Key sections: Codebase Concerns, Tech Debt, Known Bugs, Security Considerations, Performance Bottlenecks, Fragile Areas.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0036` and `.planning/codebase/CONCERNS.md` in `.planning/specs/INVENTORY.md`.
