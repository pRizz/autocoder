...
## Purpose
Defines configuration or packaging behavior in `pyproject.toml` that influences runtime/tooling semantics.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0095` and `pyproject.toml` in `.planning/specs/INVENTORY.md`.
