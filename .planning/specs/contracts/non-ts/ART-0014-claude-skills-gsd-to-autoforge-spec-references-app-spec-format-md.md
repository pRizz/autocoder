# ART-0014: claude-skills-gsd-to-autoforge-spec-references-app-spec-format-md

## Artifact Identity
- ART ID: ART-0014
- Path: .claude/skills/gsd-to-autoforge-spec/references/app-spec-format.md
- Category: OPS_AUTOMATION
- Contract Version: 1.0

## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/skills/gsd-to-autoforge-spec/references/app-spec-format.md` to standardize repository workflows. Key sections: AutoForge app_spec.txt XML Format, Root Structure, Section Details, project_name, overview, technology_stack.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0014` and `.claude/skills/gsd-to-autoforge-spec/references/app-spec-format.md` in `.planning/specs/INVENTORY.md`.
