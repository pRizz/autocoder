...
## Purpose
Documents product/runtime behavior and usage expectations in `CLAUDE.md` for operator and contributor guidance. Key sections: CLAUDE.md, Prerequisites, Project Overview, Commands, npm Global Install (Recommended), From Source (Development).
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0069` and `CLAUDE.md` in `.planning/specs/INVENTORY.md`.
