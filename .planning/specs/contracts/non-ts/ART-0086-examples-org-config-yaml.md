# ART-0086: examples-org-config-yaml

## Artifact Identity
- ART ID: ART-0086
- Path: examples/org_config.yaml
- Category: CONFIG_OR_MISC
- Contract Version: 1.0

## Purpose
Defines configuration or packaging behavior in `examples/org_config.yaml` that influences runtime/tooling semantics.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0086` and `examples/org_config.yaml` in `.planning/specs/INVENTORY.md`.
