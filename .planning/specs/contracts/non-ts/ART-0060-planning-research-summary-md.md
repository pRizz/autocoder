# ART-0060: planning-research-summary-md
...
## Purpose
Defines planning and verification behavior for `.planning/research/SUMMARY.md` used to drive deterministic phase execution and traceability. Key sections: Project Research Summary, Executive Summary, Key Findings, Recommended Stack, Expected Features, Architecture Approach.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0060` and `.planning/research/SUMMARY.md` in `.planning/specs/INVENTORY.md`.
