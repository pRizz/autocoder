...
## Purpose
Implements operational startup/control behavior in `start_ui.sh` for local runtime launch and environment preparation.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0137` and `start_ui.sh` in `.planning/specs/INVENTORY.md`.
