# ART-0040: planning-codebase-structure-md
...
## Purpose
Defines planning and verification behavior for `.planning/codebase/STRUCTURE.md` used to drive deterministic phase execution and traceability. Key sections: Codebase Structure, Directory Layout, Directory Purposes, Key File Locations, Naming Conventions, Where to Add New Code.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0040` and `.planning/codebase/STRUCTURE.md` in `.planning/specs/INVENTORY.md`.
