# ART-0007: claude-commands-expand-project-md

## Artifact Identity
- ART ID: ART-0007
- Path: .claude/commands/expand-project.md
- Category: OPS_AUTOMATION
- Contract Version: 1.0

## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/commands/expand-project.md` to standardize repository workflows. Key sections: PROJECT DIRECTORY, GOAL, YOUR ROLE, FIRST: Read and Understand Existing Project, CONVERSATION FLOW, Phase 1: Understand Additions.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0007` and `.claude/commands/expand-project.md` in `.planning/specs/INVENTORY.md`.
