# ART-0016: claude-skills-playwright-cli-references-request-mocking-md

## Artifact Identity
- ART ID: ART-0016
- Path: .claude/skills/playwright-cli/references/request-mocking.md
- Category: OPS_AUTOMATION
- Contract Version: 1.0

## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/skills/playwright-cli/references/request-mocking.md` to standardize repository workflows. Key sections: Request Mocking, CLI Route Commands, Mock with custom status, Mock with JSON body, Mock with custom headers, Remove headers from requests.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0016` and `.claude/skills/playwright-cli/references/request-mocking.md` in `.planning/specs/INVENTORY.md`.
