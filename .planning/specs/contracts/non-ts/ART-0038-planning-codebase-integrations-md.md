# ART-0038: planning-codebase-integrations-md
...
## Purpose
Defines planning and verification behavior for `.planning/codebase/INTEGRATIONS.md` used to drive deterministic phase execution and traceability. Key sections: External Integrations, APIs & External Services, Data Storage, Authentication & Identity, Monitoring & Observability, CI/CD & Deployment.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0038` and `.planning/codebase/INTEGRATIONS.md` in `.planning/specs/INVENTORY.md`.
