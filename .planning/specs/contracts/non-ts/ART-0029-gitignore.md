...
## Purpose
Defines configuration or packaging behavior in `.gitignore` that influences runtime/tooling semantics.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0029` and `.gitignore` in `.planning/specs/INVENTORY.md`.
