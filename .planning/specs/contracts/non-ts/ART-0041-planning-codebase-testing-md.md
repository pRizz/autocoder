# ART-0041: planning-codebase-testing-md
...
## Purpose
Defines planning and verification behavior for `.planning/codebase/TESTING.md` used to drive deterministic phase execution and traceability. Key sections: Testing Patterns, Test Framework, Test File Organization, Test Structure, Mocking, Fixtures and Factories.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0041` and `.planning/codebase/TESTING.md` in `.planning/specs/INVENTORY.md`.
