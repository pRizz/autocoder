# ART-0022: claude-skills-playwright-cli-references-video-recording-md

## Artifact Identity
- ART ID: ART-0022
- Path: .claude/skills/playwright-cli/references/video-recording.md
- Category: OPS_AUTOMATION
- Contract Version: 1.0

## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/skills/playwright-cli/references/video-recording.md` to standardize repository workflows. Key sections: Video Recording, Basic Recording, Start recording, Perform actions, Stop and save, Best Practices.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0022` and `.claude/skills/playwright-cli/references/video-recording.md` in `.planning/specs/INVENTORY.md`.
