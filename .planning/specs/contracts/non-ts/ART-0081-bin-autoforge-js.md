# ART-0081: bin-autoforge-js

## Artifact Identity
- ART ID: ART-0081
- Path: bin/autoforge.js
- Category: OPERATIONS_SCRIPT
- Contract Version: 1.0

## Purpose
Implements operational startup/control behavior in `bin/autoforge.js` for local runtime launch and environment preparation.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0081` and `bin/autoforge.js` in `.planning/specs/INVENTORY.md`.
