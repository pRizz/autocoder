...
## Purpose
Implements operational startup/control behavior in `start_ui.py` for local runtime launch and environment preparation.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0136` and `start_ui.py` in `.planning/specs/INVENTORY.md`.
