# ART-0057: planning-research-features-md
...
## Purpose
Defines planning and verification behavior for `.planning/research/FEATURES.md` used to drive deterministic phase execution and traceability. Key sections: Feature Research, Feature Landscape, Table Stakes (Users Expect These), Differentiators (Competitive Advantage), Anti-Features (Commonly Requested, Often Problematic), Feature Dependencies.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0057` and `.planning/research/FEATURES.md` in `.planning/specs/INVENTORY.md`.
