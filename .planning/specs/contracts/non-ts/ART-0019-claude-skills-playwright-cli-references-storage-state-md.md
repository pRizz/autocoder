# ART-0019: claude-skills-playwright-cli-references-storage-state-md

## Artifact Identity
- ART ID: ART-0019
- Path: .claude/skills/playwright-cli/references/storage-state.md
- Category: OPS_AUTOMATION
- Contract Version: 1.0

## Purpose
Defines agent command/skill/prompt automation behavior in `.claude/skills/playwright-cli/references/storage-state.md` to standardize repository workflows. Key sections: Storage Management, Storage State, Save Storage State, Save to auto-generated filename (storage-state-{timestamp}.json), Save to specific filename, Restore Storage State.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0019` and `.claude/skills/playwright-cli/references/storage-state.md` in `.planning/specs/INVENTORY.md`.
