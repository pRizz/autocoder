# ART-0110: server-routers-projects-py

## Artifact Identity
- ART ID: ART-0110
- Path: server/routers/projects.py
- Category: BACKEND_SOURCE
- Contract Version: 1.0

## Purpose
Defines HTTP/WebSocket route behavior in `server/routers/projects.py` and translates API surface contracts into service-layer execution. Primary symbols: _init_imports, _get_registry_functions, validate_project_name, get_project_stats, list_projects, create_project, get_project, delete_project.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0110` and `server/routers/projects.py` in `.planning/specs/INVENTORY.md`.
