# ART-0083: env-constants-py

## Artifact Identity
- ART ID: ART-0083
- Path: env_constants.py
- Category: BACKEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements backend runtime behavior in `env_constants.py` as part of the AutoForge control-plane execution stack.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0083` and `env_constants.py` in `.planning/specs/INVENTORY.md`.
