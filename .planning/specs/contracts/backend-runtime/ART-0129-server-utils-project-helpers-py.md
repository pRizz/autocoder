# ART-0129: server-utils-project-helpers-py

## Artifact Identity
- ART ID: ART-0129
- Path: server/utils/project_helpers.py
- Category: BACKEND_SOURCE
- Contract Version: 1.0

## Purpose
Provides reusable backend utility logic in `server/utils/project_helpers.py` used by routers/services for validation and process safety. Primary symbols: get_project_path.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0129` and `server/utils/project_helpers.py` in `.planning/specs/INVENTORY.md`.
