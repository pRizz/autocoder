# ART-0116: server-services-init-py

## Artifact Identity
- ART ID: ART-0116
- Path: server/services/__init__.py
- Category: BACKEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements stateful backend service behavior in `server/services/__init__.py` for process/session/control-plane lifecycle operations.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0116` and `server/services/__init__.py` in `.planning/specs/INVENTORY.md`.
