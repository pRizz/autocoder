...
## Purpose
Implements backend runtime behavior in `server/__init__.py` as part of the AutoForge control-plane execution stack.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0101` and `server/__init__.py` in `.planning/specs/INVENTORY.md`.
