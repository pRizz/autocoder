# ART-0077: api-migration-py

## Artifact Identity
- ART ID: ART-0077
- Path: api/migration.py
- Category: BACKEND_SOURCE
- Contract Version: 1.0

## Purpose
Implements backend data/domain contract logic in `api/migration.py` that is consumed by server routes, services, and orchestration flows. Primary symbols: migrate_json_to_sqlite, export_to_json.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0077` and `api/migration.py` in `.planning/specs/INVENTORY.md`.
