# ART-0113: server-routers-spec-creation-py

## Artifact Identity
- ART ID: ART-0113
- Path: server/routers/spec_creation.py
- Category: BACKEND_SOURCE
- Contract Version: 1.0

## Purpose
Defines HTTP/WebSocket route behavior in `server/routers/spec_creation.py` and translates API surface contracts into service-layer execution. Primary symbols: SpecSessionStatus, list_spec_sessions, get_session_status, cancel_session, SpecFileStatus, get_spec_file_status, spec_chat_websocket.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0113` and `server/routers/spec_creation.py` in `.planning/specs/INVENTORY.md`.
