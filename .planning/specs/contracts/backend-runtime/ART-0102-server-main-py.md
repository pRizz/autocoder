...
## Purpose
Bootstraps FastAPI runtime, middleware, route mounting, and websocket lifecycle integration in `server/main.py`. Primary symbols: lifespan, websocket_endpoint, health_check, setup_status.
...
## Acceptance Checks
- [ ] Artifact identity exactly matches `ART-0102` and `server/main.py` in `.planning/specs/INVENTORY.md`.
